...
Whenever an [account type](/guide/accounts/#account-types) is added or changed for a Solidrock account, or an association to a team or group is made or deleted, the relevant contact in Hubspot is created or updated and tagged with the relevant information.
