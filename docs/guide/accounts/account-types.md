...
- [Front of House User](#front-of-house-user)
...
Admins can read and write all event comments related to delegates.

### Front of House User

Front of House users have permission to access the Front of House management pages that they have been granted permission to, as well as being able to access all other publicly available pages and their own profile. These users **do not** have access to the backend event management pages. Front of House Admins and Event Organiser can create and manage Front of House Users, assigning specific permission on a per user basis to access the different Front of House management pages. For example they could access one or more of the following:
...
In addition they could be given permission to read and/or write at event comments related to delegates within the following categories:
