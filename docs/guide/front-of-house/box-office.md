...
The Box Office will list available (not sold out, enabled and within the available from and to dates) [Tickets](/guide/tickets/ticket-options) & [Extras](/guide/extras/extra-options) as specified within the event management backend.
